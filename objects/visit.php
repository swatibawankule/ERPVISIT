...
function readOne(){
    ...
    $query = "SELECT
                ...
                cust_id, emp_id_created, date_time, prod_name, application, description, status, status_date, last_updated_by, image_name, region
    ...
    $row = $stmt->fetch(PDO::FETCH_ASSOC);
        ...
        $this->customer_id = $row['cust_id'];
        
        $this->emp_id_created= $row['emp_id_created'];
        
        $this->visit_date = $row['date_time'];

        $this->product_name = $row['prod_name'];
