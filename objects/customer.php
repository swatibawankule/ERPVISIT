    ...
    function create(){
        ...
        $query = "INSERT INTO
                ...
                SET
                    ...
                    cust_id=:cust_id, cust_name=:cust_name, contact_person=:contact_person, contact_number=:contact_number, customer_email=:customer_email, associated_agent=:associated_agent, business_line=:business_line, end_use=:end_use, prod_group=:prod_group, product=:product, project=:project, location=:location, region=:region";
