    ...
    function create(){
        ...
        $query = "INSERT INTO
                ...
                SET
                    ...
                    emp_id=:emp_id, emp_name=:emp_name, emp_roll=:emp_roll, mobile_number=:mobile_number, mail_id=:mail_id, location=:location, region=:region, password=:password, agent_flag=:agent_flag";
...
//        die($query);
        ...
        $this->agentFlag=htmlspecialchars(strip_tags($this->agentFlag));
        ...
        $stmt->bindParam(":agent_flag", $this->agentFlag);
...
public function countAll(){
    ...
    $query = "SELECT
               ...
               `sr_no`, `emp_id`, `emp_name`, `emp_roll`, `mobile_number`, `mail_id`, `location`, `region`, `password`, `agent_flag`, `insert_time_stamp`, `update_time_stamp`
...
function readOne(){
    ...
    $query = "SELECT
                ...
                emp_id, emp_name, emp_roll, mobile_number, mail_id, location, region, password, agent_flag
...
function update(){
    ...
    $query = "UPDATE
            ...
            SET
                 ...
                 emp_id=:emp_id, emp_name=:emp_name, emp_roll=:emp_roll, mobile_number=:mobile_number, mail_id=:mail_id, location=:location, region=:region, password=:password
