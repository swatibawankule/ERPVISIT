...
if($_POST){
        ...
        $visit->visit_id = $_POST['visit_id'];
        $visit->emp_id_created = "admin";
        $visit->visit_date = $_POST['visit_date']." : ".$_POST['visit_time'];
  ...
  window.alert('Follow Up Added');
  window.location.href='timeline.php?visit_id=$visit->visit_id';
  </script>");
...
if (isset($_GET["visit_id"])) {
    ...
    header("location:visit_dashboard.php");
}
?>
            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="visit_id" value="<?php 
                        echo$visit_id; ?>">
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <Select name="customer_id" required class="form-control" >
                                            ...
                                            <?php
                                            require_once'dbconfig.php';
                                            $SELECT = "SELECT * FROM  visit_master inner join customer_master on visit_master.cust_id=customer_master.cust_id where visit_id=$visit_id";
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <Select name="contact_person_name" required class="form-control" >
                                       
                                            <?php
                                            require_once'dbconfig.php';
                                            $SELECT = "SELECT * FROM  visit_master  where visit_id=$visit_id";
                                            $result = $conn->query($SELECT);
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo'<option value="' . $row["contact_person_name"] . '">' . $row["contact_person_name"] . ' </option>';
                                                }
                                            }
                                            ?>
...
<!--                                <input name="emp_id_created">-->
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        <label >Visit Date  <span id="redStarMark">*</span></label>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        <label >Visit  Time <span id="redStarMark">*</span></label>
                                        <input type="time" required class="form-control" name="visit_time"  title="Enter valid Date" value="<?php
                                        date_default_timezone_set("Asia/Calcutta");
                                        echo date("d/m/Y  h:i:s A") ?>">
