...
`sr_no`, `emp_id`, `emp_name`, `emp_roll`, `mobile_number`, `mail_id`, `location`, `region`, `password`, `insert_time_stamp`, `update_time_stamp`
...
function readOne(){
    ...
    $query = "SELECT
                ...
                emp_id, emp_name, emp_roll, mobile_number, mail_id, location, region, password
